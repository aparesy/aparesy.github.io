...
For my second year, I also trained for ICPC and went to SWERC. It was a really nice experience, and it's really impressive how strong the competition gets at this level. I'm also trying to animate a competitive programming club at Polytechnique and organize some events, but for now it's mostly a work in progress. Apart from all these endeavors in algorithms, I also took a course in fundamental computer science (stuff like computability, NP-completeness and automata theory), and I'm doing a project in machine learning (we've recently had an accepted paper at the AIED conference, I'll upload it soon !)
