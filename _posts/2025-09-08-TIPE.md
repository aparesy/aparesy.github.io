...
Note : The original version in french can be found on my [Github](https://github.com/aparesy/TipeGaleStewart/blob/main/Tipe_2.pdf). I actually didn't translate everything by hand (I used ChatGPT), so there might be some typos in the file below.
